<?php
    ...
    $sql = "SELECT * FROM `car` WHERE  categories_id=?  ";
    $carstmt = $conn->prepare($sql);
    $carstmt->execute([$categories_id]);
        ...
        <div class="container pt-5">
            <div class="row">
                <div class="col-lg-8 mb-5">
                    <h1 class="display-4 text-uppercase mb-5"><?php echo $titel ?></h1>
                    ...
                    <div class="row pt-2">
                        ...
                        <div class="col-md-3 col-6 mb-2">
                            ...
                            <span> properties:<?php echo $properties ?></span>
                        </div>
            ...
            <div class="owl-carousel related-carousel position-relative" style="padding: 0 30px;">
               ...
               foreach($carstmt->fetchAll() as $row){
                ...
                <div class="rent-item">
                    ...
                    <h4 class="text-uppercase mb-4"><?php echo $titel ?></h4>
